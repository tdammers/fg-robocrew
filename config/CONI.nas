            ...
            func {
                if (targetMP == nil) {
                    ...
                    for (var e = 0; e < 4; e +=1 ) {
                        ...
                        if (getprop('/controls/engine[' ~ e  ~ ']/boost-speed'))
                            report ~= '[L]';
                        else
                            report ~= '[H]';
                    }
            ...
            me.listener = setlistener(rcprops.flightPhase, func (node) {
                ...
                if (phase == 'PREFLIGHT') {
                    foreach (var e; [0,1,2,3]) {
                        ...
                        # blower: low
                        me.addJob(PropertySetJob.new(
                            '/controls/engines/engine[' ~ e ~ ']/boost-speed',
                            0,
                            controlProps.flightEngineer.throttle));
                    ...
                    me.addJob(PropertySetJob.new(
                        ...
                        -1.0,
                        controlProps.flightEngineer.pitch));
                }
                elsif (phase == 'TAKEOFF') {
                    foreach (var e; [0,1,2,3]) {
                        # cowl flaps: 100%
                    ...
                    me.addJob(PropertySetJob.new(
                        '/controls/engines/propeller-pitch-all',
                        -0.95,
                        controlProp.flightEngineer.rpm));
                        ...
                        (func (ee) {
                            me.addJob({
                                ...
                                update: func (dt) {
                                    ...
                                    var blower = getprop('/controls/engines/engine[' ~ ee ~ ']/boost-speed') or 0;
                                    if (alt > 9000.0 and blower == 0) {
                                        setprop('/controls/engines/engine[' ~ ee ~ ']/throttle', 0.5);
                                        setprop('/controls/engines/engine[' ~ ee ~ ']/boost-speed', 1);
                                    }
                                },
                            });
                        })(e);
                            ...
                            me.addJob({
                                ...
                                update: func (dt) {
                                    ...
                                    if (alt < 9000.0 and blower == 1) {
                                        setprop('/controls/engines/engine[' ~ ee ~ ']/boost-speed', 0);
                                    }
                                },
                            });
                        })(e);
